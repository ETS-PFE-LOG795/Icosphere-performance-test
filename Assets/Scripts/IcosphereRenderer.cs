...
/**
 * Inspired from https://github.com/kaiware007/IcoSphereCreator/blob/master/Assets/IcoSphereCreator/IcoSphereCreator.cs
 *
 */
[RequireComponent(typeof(MeshRenderer), typeof(MeshFilter))]
public class IcosphereRenderer : MonoBehaviour {
  private MeshRenderer _r;
  private MeshFilter _f;

  public static int numVertices(int n) {
    int nn = n * 4;
    return (nn * nn / 16) * 24;
  }
  ...
  public void Generate(int n, float radius) {
    // Init count
    int vertexNum = numVertices(n);
